...
async function userVerification() {
    const verUser: VerUser = await inquirer.prompt([
        {
            name: "username",
            type: "input",
...
async function startTransaction() {
    ...
    while (condition) {
        ...
        const atmTrans: AtmTrans = await inquirer.prompt([
            {
            ...
            },
            {
                ...
                when: (atmTrans) =>
                    atmTrans.transactionType == "Fast Cash"
            },
            {
                name: "enterAmount",
                type: "input",
                ...
                when: (atmTrans) =>
                    atmTrans.transactionType == "Other Amount"
            },
            {
                name: "changeUsername",
                type: "input",
                ...
                when: (atmTrans) =>
                    atmTrans.transactionType == "Change Username"
            },
            {
                name: "changePin",
                type: "input",
                ...
                when: (atmTrans) =>
                    atmTrans.transactionType == "Change Pin"
            }
        ])
